...
const JournalCard: FC<JournalCardProps> = ({ subject, mark, currentScore }) => {
  ...
  return (
    <div
      className={cn(
        'my-2.5 h-fit min-h-24 flex-col overflow-hidden rounded-xl border border-content/10 bg-card/80 shadow-none backdrop-blur-sm transition-colors hover:border-content/30',
        classes.card,
      )}
    >
